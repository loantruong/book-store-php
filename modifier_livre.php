...
<div>
    <a href="modifier_livre.php">Modifier un livre</a>
</div>
    ...
    if(isset($_POST["envoyer"])){
        ...
        if(strpos($date, "/") != 0){
            ...
            if(checkdate($mois, $jour, $annee)){
                ...
                header("location:modifier_livre.php?erreurDate");
                exit();
            }
        }
        ...
        header("location:modifier_livre.php?erreurModification&id=$id");
            //en mode dev : pour tester et cacher le header
            //echo mysqli_error($co);
        exit();
        }else{
            header("location:admin_livres.php?modification");
            exit();
        }
    }
?>
